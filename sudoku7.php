...
<body>	
	<img class="banner" src="sudokubanner.png">
    <?php
        ...
        for($i=0;$i<$rows;$i++){
             echo '<tr class="tr_border" id="row_'.$i.'">';
				...
				if($i==0 && $j==0){
					...
					echo sprintf('<td class="col_'.$j.'"><input type="hidden" id="%s_%s" name="%s" value="3" min="3" max="3">3</td>',
					$i,
					$j,
					"inputs[{$i}][{$j}]"
					); 
					...
					echo sprintf('<td class="col_'.$j.'"><input type="hidden" id="%s_%s" name="%s" value="7" min="7" max="5">7</td>',
					$i,
					$j,
					"inputs[{$i}][{$j}]"
					); 
					...
					echo sprintf('<td class="col_'.$j.'"><input type="hidden" id="%s_%s" name="%s" value="6" min="6" max="6">6</td>',
					$i,
					$j,
					"inputs[{$i}][{$j}]"
					); 
					...
					echo sprintf('<td class="col_'.$j.'"><input type="hidden" id="%s_%s" name="%s" value="1" min="1" max="1">1</td>',
					$i,
					$j,
					"inputs[{$i}][{$j}]"
					); 
					...
					echo sprintf('<td class="col_'.$j.'"><input type="hidden" id="%s_%s" name="%s" value="9" min="9" max="9">9</td>',
					$i,
					$j,
					"inputs[{$i}][{$j}]"
					); 
					...
					echo sprintf('<td class="col_'.$j.'"><input type="hidden" id="%s_%s" name="%s" value="8" min="8" max="8">8</td>',
					$i,
					$j,
					"inputs[{$i}][{$j}]"
					); 
					...
					echo sprintf('<td class="col_'.$j.'"><input type="hidden" id="%s_%s" name="%s" value="4" min="4" max="4">4</td>',
					$i,
					$j,
					"inputs[{$i}][{$j}]"
					); 
					...
					echo sprintf('<td class="col_'.$j.'"><input type="hidden" id="%s_%s" name="%s" value="7" min="7" max="7">7</td>',
					$i,
					$j,
					"inputs[{$i}][{$j}]"
					); 
					...
					echo sprintf('<td class="col_'.$j.'"><input type="hidden" id="%s_%s" name="%s" value="2" min="2" max="2">2</td>',
					$i,
					$j,
					"inputs[{$i}][{$j}]"
					); 
